...
<div class="content">
    ...
    <div class="list__button">
        <a href="/stamp_correction_request/list?status=承認待ち" class="list__btn {{ isset($status) && $status == '承認待ち' ? 'active' : '' }}">承認待ち</a>
        <a href="/stamp_correction_request/list?status=承認済み" class="list__btn {{ isset($status) && $status == '承認済み' ? 'active' : '' }}">承認済み</a>
    </div>
    <table class="table">
        <tr class="label_row">

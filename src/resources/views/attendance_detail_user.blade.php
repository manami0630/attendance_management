        ...
        @if($applicationStatus === '承認待ち')
            <table class="table">
                ...
                <tr class="row">
                    ...
                    <td class="data">
                        <input class="applications_remarks" type="text" name="reason" value="{{ $applicationReason ?? '' }}">
                    </td>
                </tr>
            </table>
        ...
        @else
            <table class="table">
                ...
                <tr class="row">
                    ...
                    @endif
                    <td class="data">
                        <input type="hidden" name="break_time_ids[{{ $index }}]" value="{{ $break->id ?? '' }}">
                ...
                @if($applicationStatus === '承認済み')
                    <tr class="row">
                        <th class="label">備考</th>
                        <td class="data">
                            <input class="remarks" type="text" name="reason" value="{{ $application->reason ?? '' }}">
                        </td>
                    </tr>
                @else
                    <tr class="row">
